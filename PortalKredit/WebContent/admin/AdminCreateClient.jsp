			...
			<div class="card card-outline-primary mb-3 text-center blue-outline">
				...
				<div class="card-block">
					<form action="" method="post">
						...
						<div class="form-group">
							<input type="text" class="form-control bfh-phone" data-country="createClientCountry" name="clientTelephone"
						...
						<div class="form-group">
							<select class="form-control bfh-countries" data-country="DK" id="createClientCountry"></select>
						</div>
