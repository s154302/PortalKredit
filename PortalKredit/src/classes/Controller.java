...
public final class Controller {
	...
	public static void createClient(String firstName, String lastName, String password, String CPR, String email,
			String mobile, String street, String bankerID, Integer postal, String country, Connection ds1) throws SQLException {
//TODO - Might consider making a try catch 
			PreparedStatement ps = ds1.prepareStatement(
	...
	public static void createAccount(String accountName, String accountNumber, int regNo, String accountType, String clientID, double balance, String currency, Connection ds1) throws SQLException {
	...
	public static boolean transaction(String sendAcc, String reciAcc, double amount, int sendReg, int reciReg,
		...
		try {			
			...
			PreparedStatement oldBalances = ds1.prepareStatement("SELECT \"BALANCE\" FROM \"DTUGRP16\".\"ACCOUNT\" WHERE \"ACCOUNTNUMBER\" = ? OR \"ACCOUNTNUMBER\" = ?");
